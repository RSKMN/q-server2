...
- Orchestration configurations (Prefect flows)
...
### `/orchestration`
**Purpose**: Prefect flow definitions for scheduled pipeline execution.

Contains:
- Daily data pipeline flow
- Task definitions and retries
