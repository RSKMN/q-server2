...
const DASHBOARD_NAV_ITEMS: NavItem[] = [
  ...
  { label: "Targets", href: "/targets", icon: <path d="M12 2v3m0 14v3m-9-9h3m14 0h3m-9-7a7 7 0 1 0 0 14 7 7 0 0 0 0-14z" /> },
  { label: "Docking Studio", href: "/docking", icon: <path d="M12 2l8.66 5v10L12 22l-8.66-5V7L12 2z M12 7l5.2 3v4l-5.2 3l-5.2-3v-4l5.2-3" /> },
  { label: "Models", href: "/models", icon: <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /> },
  ...
  { label: "Quantum", href: "/quantum", icon: <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zM12 8a4 4 0 1 1 0 8 4 4 0 0 1 0-8z" /> },
  { label: "Results", href: "/results", icon: <path d="M5 4h14v16H5V4Zm2 2v12h10V6H7Zm2 2h6v2H9V8Zm0 4h6v2H9v-2Z" /> },
  { label: "Validation", href: "/validation", icon: <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /> },
